              ...
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div className="flex-grow sm:pl-8">
                  ...
                  <p className="mb-4 font-thin">
                    I am currently training as a Web Developer in Kodego. I was
                    a student of De La Salle University-Dasmariñas. My technical
                    skills include having knowledge about HTML, CSS, and
                    JavaScript. Furthermore, I also possess the knowledge in
                    Programming languages such as C, C++, C#, Android Studio,
                    Python, Object Oriented Programming and Assembly Language. I
                    also have knowledge when it comes into Database Management,
                    CISCO Networking, and Microsoft Office (MS Word, PowerPoint,
                    and Excel).
                  </p>
