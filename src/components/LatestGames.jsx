							...
							return (
								<div className='xl:w-1/4 md:w-1/2 p-4' key={index}>
									<div className='bg-[#201B1B] rounded-lg'>
										<img className='h-40 w-full object-cover object-center mb-6' src={game.thumbnail} alt='content'></img>
										<div className='px-6 py-5'>
											<h3 className='halant text-white text-xl font-semibold'>{game.title}</h3>
											<h2 className='halant text-white my-2'>
												Release Date:
												<span className='text-[#DC3D4B] ml-1'>{game.release_date}</span>
											</h2>
											<div className='flex justify-end'>
												<button className='nunito px-4 py-1 bg-[#747474] text-white text-sm rounded-full'>{game.genre}</button>
											</div>
										</div>
									</div>
								</div>
