	...
	return (
		<div className='bg-[#261F1F]'>
			<div className='container mx-auto'>
				<h5 className=' halant text-6xl text-center text-white my-20 underline'>LATEST NEWS</h5>
				{isLoading && (
					<div className='mx-auto'>
						<SpinnerDotted size='10%' color='#DC3D4B' className='mx-auto mb-10' />
					</div>
				)}
				<div className='flex flex-wrap gap-8 bg-[#281D1D] halant text-white pb-40'>
					{news &&
						!isLoading &&
				      ...
				      ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}
								...
								>
									...
									<div className={`p-3 ${index % 2 !== 0 ? 'lg:text-right' : ''}`}>
										<div className='mb-2'>
										...
										<div className='mb-2'>
											<p>
												<span className='nunito text-sm px-2'>{description}</span>
											</p>
										</div>
